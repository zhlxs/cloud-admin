...
import com.it.dto.NoticeReadVO;
import com.it.entity.NoticeDO;
...
public interface NoticeDao
{
	...
	List<NoticeDO> list(@Param("params") Map<String, Object> params, @Param("offset") Integer offset, @Param("limit") Integer limit);
	...
	List<SysUserDO> listReadUsers(Long noticeId);
	...
	List<NoticeReadVO> listNotice(@Param("params") Map<String, Object> params, @Param("offset") Integer offset, @Param("limit") Integer limit);
}

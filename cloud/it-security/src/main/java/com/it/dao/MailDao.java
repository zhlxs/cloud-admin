...
import com.it.entity.MailDO;
import com.it.entity.MailTo;
...
public interface MailDao
{
	...
	List<MailDO> list(@Param("params") Map<String, Object> params, @Param("offset") Integer offset, @Param("limit") Integer limit);
}
